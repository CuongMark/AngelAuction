 ...
 * @since 101.0.0
 */
class AutoBid extends \Magento\Catalog\Ui\DataProvider\Product\Form\Modifier\AbstractModifier
{
    const GROUP_REVIEW = 'auction_autobid';
    const GROUP_CONTENT = 'auction_bid';

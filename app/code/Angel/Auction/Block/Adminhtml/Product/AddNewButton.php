...
namespace Angel\Auction\Block\Adminhtml\Product;
...
class AddNewButton extends GenericButton implements ButtonProviderInterface
{
    ...
    {
        return [
            'label' => __('Add New Auction'),
            'on_click' => sprintf("location.href = '%s';", $this->_getProductCreateUrl(\Angel\Auction\Model\Product\Type::TYPE_CODE)),
            'class' => 'primary',
            'id' => 'add',
            'sort_order' => 10
        ];
